    ...
    return {
        ...
        unmemoize: function (memoId, callbackParams) {
            ...
            if (callback === undefined)
                throw new Error("Couldn't find any memo with AggregateRootId " + memoId + ". Perhaps it's already been unmemoized.");
            try {
...
ko.templateEngine.prototype['makeTemplateSource'] = function(template, templateDocument) {
    ...
    if (typeof template == "string") {
        ...
        if (!elem)
            throw new Error("Cannot find template with AggregateRootId " + template);
...
(function() {
    ko.jqueryTmplTemplateEngine = function () {
        ...
        this['addTemplate'] = function(templateName, templateMarkup) {
            document.write("<script type='text/html' AggregateRootId='" + templateName + "'>" + templateMarkup + "</script>");
        };
